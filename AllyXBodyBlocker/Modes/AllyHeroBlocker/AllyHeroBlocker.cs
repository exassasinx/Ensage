namespace AllyXBodyBlocker.Modes.AllyHeroBlocker
{
    ...
    internal class AllyHeroBlocker : IBodyBlockMode
    {
        private readonly Unit hero;

        private AllyHeroBlockerSettings settings;

        private IUpdateHandler updateHandler;

        [ImportingConstructor]
        public AllyHeroBlocker(IServiceContext context)
        {
            hero = context.Owner;
        }
        ...
        {
            settings = new AllyHeroBlockerSettings();
